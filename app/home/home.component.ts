...
export class HomeComponent {
    ...
    constructor(private animationsService: AnimationsService,
        ...
        this._books = this.booksService.getBooks();
    ...
    public onNavigationItemTap(args: any) {
        this.booksService.setSelectedId(args.index);
    ...
    private _prepareForBackNavigation() {
        ...
        this._imageRef.nativeElement.src = this.booksService.getSelected().imageLink;
